...
REPOSITORY_LOCATIONS_SPEC = dict(
    ...
    com_envoyproxy_protovalidate = dict(
        project_name = "protovalidate",
        project_desc = "protoc plugin to generate polyglot message validators, successor to PGV",
        ...
        version = "0.10.0",
        urls = ["https://github.com/bufbuild/protovalidate/releases/download/v{version}/protovalidate-{version}.tar.gz"],
    ...
    rules_buf = dict(
        project_name = "rules_buf",
        project_desc = "rules_buf",
        project_url = "https://github.com/bufbuild/rules_buf",
        use_category = ["api"],
        sha256 = "1ebeb843f09a62bd04de9b408c43a0759775c9cf9c063a7b386d70cee7f70c8b",
        version = "0.3.0",
        urls = ["https://github.com/bufbuild/rules_buf/archive/refs/tags/v{version}.zip"],
        strip_prefix = "rules_buf-{version}",
        release_date = "2024-05-22",
        license = "Apache-2.0",
        license_url = "https://github.com/bufbuild/rules_buf/blob/v{version}/LICENSE",
    ),
